        ...
        <div className="container mx-auto px-4 pt-16 pb-8 lg:pt-24 lg:pb-14">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#3972FE]/30 bg-[#3972FE]/10 px-3 py-1 text-[#3972FE] text-sm">
              <Shield className="h-4 w-4" /> {t("info_pages:privacy.badge", "Политика конфиденциальности")}
            </div>
            <h1 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight tracking-tight">
              {t("info_pages:privacy.hero_title", "Как мы защищаем ваши данные")}
            </h1>
            ...
            <p className="mt-2 flex items-center gap-2 text-sm text-slate-500">
              ...
              {t("info_pages:privacy.updated_at", "Последнее обновление: {{date}}", {
                date: updatedAt,
              })}
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-6">
          ...
          <aside className="lg:sticky lg:top-24 h-max">
            <nav className="rounded-2xl border border-slate-200 bg-white/70 p-4 text-sm">
              <p className="mb-2 font-semibold text-slate-700">{t("info_pages:privacy.toc.title", "Оглавление")}</p>
              <ul className="space-y-2">
                {[
                  ["scope", t("info_pages:privacy.toc.scope", "1. Область действия")],
                  ["data", t("info_pages:privacy.toc.data", "2. Какие данные мы собираем")],
                  ["use", t("info_pages:privacy.toc.use", "3. Как мы используем данные")],
                  ["lawful", t("info_pages:privacy.toc.lawful", "4. Правовые основания обработки")],
                  ["cookies", t("info_pages:privacy.toc.cookies", "5. Файлы cookie и аналитика")],
                  ["sharing", t("info_pages:privacy.toc.sharing", "6. Передача третьим лицам")],
                  ["retention", t("info_pages:privacy.toc.retention", "7. Сроки хранения")],
                  ["security", t("info_pages:privacy.toc.security", "8. Безопасность")],
                  ["rights", t("info_pages:privacy.toc.rights", "9. Права пользователей")],
                  ["children", t("info_pages:privacy.toc.children", "10. Дети и уязвимые лица")],
                  ["transfer", t("info_pages:privacy.toc.transfer", "11. Трансграничная передача")],
                  ["changes", t("info_pages:privacy.toc.changes", "12. Изменения политики")],
                  ["contact", t("info_pages:privacy.toc.contact", "13. Контакты")],
                ].map(([id, label]) => (
                  <li key={id}>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-6 lg:p-8 prose prose-slate max-w-none">
            <h2 id="scope">{t("info_pages:privacy.h.scope", "1. Область действия")}</h2>
            <p>
              {t(
            ...
            <h2 id="data">{t("info_pages:privacy.h.data", "2. Какие данные мы собираем")}</h2>
            <ul>
              <li>
                <strong>{t("info_pages:privacy.li.account_bold", "Учётные данные: ")}</strong>
                {t(
              ...
              <li>
                <strong>{t(
                    "info_pages:privacy.li.ops_bold",
                    "Операционные данные: "
                )}</strong>
                {t(
              ...
              <li>
                <strong>{t("info_pages:privacy.li.tech_bold", "Техданные: ")}</strong>
                {t(
              ...
              <li>
                ...
                )}</strong> ({t("info_pages:privacy.li.if_applicable", "если применимо")}):
                {t(
            ...
            <h2 id="use">{t("info_pages:privacy.h.use", "3. Как мы используем данные")}</h2>
            <ul>
              <li>
                {t(
              ...
              <li>{t("info_pages:privacy.li.use.support", "поддержка пользователей и обратная связь;")}</li>
              <li>
                {t(
            ...
            <h2 id="lawful">{t("info_pages:privacy.h.lawful", "4. Правовые основания обработки")}</h2>
            <p>
              {t(
            ...
            <h2 id="cookies">{t("info_pages:privacy.h.cookies", "5. Файлы cookie и аналитика")}</h2>
            <p>
              {t(
            ...
            <h2 id="sharing">{t("info_pages:privacy.h.sharing", "6. Передача третьим лицам")}</h2>
            <ul>
              <li>
                <strong>
                  {t("info_pages:privacy.li.sharing.ops_bold", "Операторы и партнёры:")}
                </strong>{" "}
                {t(
            ...
            <h2 id="retention">{t("info_pages:privacy.h.retention", "7. Сроки хранения")}</h2>
            <p>
              {t(
            ...
            <h2 id="security">{t("info_pages:privacy.h.security", "8. Безопасность")}</h2>
            <ul>
              <li>
                {t(
            ...
            <h2 id="rights">{t("info_pages:privacy.h.rights", "9. Права пользователей")}</h2>
            <p>{t("info_pages:privacy.p.rights_intro", "В пределах применимого права вы можете:")}</p>
            <ul>
              <li>{t("info_pages:privacy.li.rights.access", "запросить доступ к вашим данным и их копию;")}</li>
              <li>{t("info_pages:privacy.li.rights.rectify", "исправить неточности и дополнить профиль;")}</li>
              <li>{t("info_pages:privacy.li.rights.erase", "удалить данные (кроме случаев обязательного хранения);")}</li>
              <li>{t("info_pages:privacy.li.rights.restrict", "ограничить обработку или возразить против неё;")}</li>
              <li>{t("info_pages:privacy.li.rights.withdraw", "отозвать согласие (если обработка основана на нём);")}</li>
              <li>{t("info_pages:privacy.li.rights.portability", "на переносимость (где применимо).")}</li>
            </ul>
            <p>
              {t("info_pages:privacy.p.rights_contact_prefix", "Для реализации прав напишите нам:")}{" "}
              <a
            ...
            <h2 id="children">{t("info_pages:privacy.h.children", "10. Дети и уязвимые лица")}</h2>
            <p>
              {t(
            ...
            <h2 id="transfer">{t("info_pages:privacy.h.transfer", "11. Трансграничная передача")}</h2>
            <p>
              {t(
            ...
            <h2 id="changes">{t("info_pages:privacy.h.changes", "12. Изменения политики")}</h2>
            <p>
              {t(
            ...
            <h2 id="contact">{t("info_pages:privacy.h.contact", "13. Контакты")}</h2>
            ...
            <p>
              {t("info_pages:privacy.p.contact_privacy_label", "Email для вопросов по конфиденциальности:")}{" "}
              <a
                className="text-[#3972FE] hover:underline"
                href="mailto:truemasters@inbox.ru"
              >
              ...
              {t("info_pages:privacy.p.contact_support_label", ". Общая поддержка:")}{" "}
              <a
                className="text-[#3972FE] hover:underline"
