...
export default function PublicationTerms() {
  const journalStats = [
    ...
    {
      label: "Срок первичного отклика",
      value: "до 5 рабочих дней",
      icon: Clock,
    },
    ...
    { label: "Допустимый объем", value: "от 4 до 12 страниц", icon: FileText },
    {
      ...
      value: "английский, русский, казахский",
      icon: Globe,
    },
  ];
      ...
      <section className="relative bg-gradient-to-br from-orange-50 via-white to-red-50 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Условия и сроки публикации
          </h1>
          <p className="text-xl text-gray-600 leading-relaxed">
            Подробная информация о стоимости, сроках и условиях публикации
            статей в журнале
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-4">
                  Стоимость публикации составляет 5 000 тенге за статью. Оплата
                  производится после принятия статьи к публикации.
                </p>
                <ul className="space-y-2 text-gray-600">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-4">
                  Авторы сохраняют авторские права на свои работы. Журнал
                  получает право на первую публикацию.
                </p>
                <ul className="space-y-2 text-gray-600">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-4">
                  Журнал индексируется в ведущих научных базах данных для
                  обеспечения максимальной видимости публикаций.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• Google Scholar</li>
                  <li>• РИНЦ (Российский индекс научного цитирования)</li>
                  <li>
                    • КазНЭБ (Казахстанская национальная электронная библиотека)
                  </li>
                  <li>• Crossref DOI</li>
                </ul>
              </CardContent>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            ...
            школ. Ознакомьтесь с требованиями к оформлению статей и подайте вашу
